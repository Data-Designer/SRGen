...
| Model | Dataset | Base Pass@1 | SRGen Pass@1 | Improvement |
|-------|---------|-------------|--------------|-------------|
| DeepSeek-R1-Distill-Qwen-7B | AIME 2024 | - | - | **+12.0%** |
| DeepSeek-R1-Distill-Qwen-7B | AIME 2024 (Cons@5) | - | - | **+13.3%** |
| Qwen3-32B | AIME (Cons@5) | 80% | 90% | **+10.0%** |
